<?php
// Filename: /mnt/d/__PROJECTS__/LARAVEL/advanced-todo-app/src/controllers/CommentController.php

require_once __DIR__ . '/../services/CommentService.php';
require_once __DIR__ . '/../services/TaskService.php'; // Must be passed to CommentService

class CommentController {
    private $commentService;

    public function __construct($db) {
        // Create a TaskService instance *just* to pass it to the CommentService
