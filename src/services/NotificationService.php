<?php
// Filename: /mnt/d/__PROJECTS__/LARAVEL/advanced-todo-app/src/services/NotificationService.php
...
class NotificationService {
    ...
    public function getNotifications($user_id) {
        // This query joins the logs, the user who acted, and the task title
        $sql = "
            SELECT 
