<?php
// Filename: /mnt/d/__PROJECTS__/LARAVEL/advanced-todo-app/src/services/AuthService.php
...
class AuthService {
    ...
    public function logout() {
        ...
        // Send a cookie to expire the session cookie
